...
main(int argc, char *argv[])
{
        ...
        fprintf(stderr, "width : %d", UArray2_width(test_array));
        fprintf(stderr, "height : %d", UArray2_height(test_array));
        fprintf(stderr, "size : %d", UArray2_size(test_array));
